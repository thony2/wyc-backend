...
<body style="margin:0;padding:0;font-family:'Helvetica Neue',Arial,sans-serif;background:#F0EEE4;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#F0EEE4;padding:40px 20px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.08);">
        <tr><td style="background:#2E2F36;padding:28px 32px;">
          <h1 style="margin:0;font-size:22px;font-weight:600;color:#fff;letter-spacing:-.01em;">West Yorkshire Carpets</h1>
          <p style="margin:4px 0 0;font-size:12px;font-weight:500;letter-spacing:.12em;text-transform:uppercase;color:#A2A8B0;">New Lead Notification</p>
        </td></tr>
        <tr><td style="background:#DE3848;padding:14px 32px;">
          <p style="margin:0;font-size:14px;font-weight:600;color:#fff;">&#x1F514;&nbsp; New enquiry received · ${escapeHtml(lead.created_at)}</p>
        </td></tr>
        <tr><td style="padding:32px;">
          <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td style="padding:6px 0;font-size:15px;"><a href="tel:${escapeHtml(lead.phone)}" style="color:#DE3848;font-weight:600;text-decoration:none;">${escapeHtml(lead.phone)}</a></td>
            </tr>
            <tr>
              <td style="padding:6px 0;color:#6b7280;font-size:14px;">Email</td>
              <td style="padding:6px 0;font-size:15px;">${lead.email && lead.email !== 'Not provided' ? `<a href="mailto:${escapeHtml(lead.email)}" style="color:#DE3848;font-weight:500;text-decoration:none;">${escapeHtml(lead.email)}</a>` : '<span style="color:#A2A8B0;">Not provided</span>'}</td>
            </tr>
            <tr>
        ...
        <tr><td style="background:#F8F7F2;border-top:1px solid #E8E5D8;padding:20px 32px;">
          <p style="margin:0;font-size:12px;color:#A2A8B0;line-height:1.5;">This email was generated automatically by the West Yorkshire Carpets lead management system.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
    ...
    const text = `NEW LEAD — West Yorkshire Carpets
