    ...
    <div class="product-detail">
      ...
      <div class="cta-block">
        ...
        <div class="cta-buttons">
          ...
          <a href="/#contact?product=${encodeURIComponent(p.name)}" class="btn-cta-secondary"><i class="fa-solid fa-calendar-check" aria-hidden="true"></i> Book Free Measure Online</a>
        </div>
